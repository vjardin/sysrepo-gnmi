...
class gNMIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Confirm = channel.unary_unary(
                '/gnmi.gNMI/Confirm',
                request_serializer=gnmi__pb2.ConfirmRequest.SerializeToString,
                response_deserializer=gnmi__pb2.ConfirmResponse.FromString,
                _registered_method=True)
        self.Rpc = channel.unary_unary(
                '/gnmi.gNMI/Rpc',
                request_serializer=gnmi__pb2.RpcRequest.SerializeToString,
                response_deserializer=gnmi__pb2.RpcResponse.FromString,
                _registered_method=True)
...
def add_gNMIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Confirm': grpc.unary_unary_rpc_method_handler(
                    servicer.Confirm,
                    request_deserializer=gnmi__pb2.ConfirmRequest.FromString,
                    response_serializer=gnmi__pb2.ConfirmResponse.SerializeToString,
            ),
            'Rpc': grpc.unary_unary_rpc_method_handler(
                    servicer.Rpc,
                    request_deserializer=gnmi__pb2.RpcRequest.FromString,
                    response_serializer=gnmi__pb2.RpcResponse.SerializeToString,
            ),
    }
...
class gNMI(object):
    ...
    def Confirm(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gnmi.gNMI/Confirm',
            gnmi__pb2.ConfirmRequest.SerializeToString,
            gnmi__pb2.ConfirmResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Rpc(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gnmi.gNMI/Rpc',
            gnmi__pb2.RpcRequest.SerializeToString,
            gnmi__pb2.RpcResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
